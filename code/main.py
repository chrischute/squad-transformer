...
tf.app.flags.DEFINE_integer("max_c_len", 400, "The maximum context length of your model at train time")
tf.app.flags.DEFINE_integer("max_q_len", 50, "The maximum question length of your model at train time")
tf.app.flags.DEFINE_integer("max_c_len_test", 600, "The maximum context length of your model at test time")
tf.app.flags.DEFINE_integer("max_q_len_test", 80, "The maximum question length of your model at test time")
